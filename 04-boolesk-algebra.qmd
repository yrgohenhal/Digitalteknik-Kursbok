...
Table: Grundläggande Booleska lagar. {#tbl-booleska_grundlagar}
...
Hittills har vi förenklat uttryck med hjälp av Boolesk algebra. Det är en elegant metod, men den kräver en hel del "pusselbitar" och risken att missa en förenkling är stor. Här kliver **Karnaughdiagrammet** (ofta förkortat K-diagram) in som en räddare i nöden.
...
![Karnaughdiagram för sanningstabellen i @tbl-tt-example-with-karnaugh.](images/04-boolesk-algebra/K_map_example_2inputs.png){#fig-example-with-karnaugh}
...
![Karnaughdiagram med tre ingångar.](images/04-boolesk-algebra/K_map_example_3inputs_around_corner.png){#fig-Karnaugh-example-with-3inputs}
...
![Karnaughdiagram med fyra variabler, $A$, $B$, $C$ och $D$. Här kombineras variablerna parvis och bildar fyra rader respektive fyra kolumner (som skrivs med Gray-kod). .](images/04-boolesk-algebra/K_map_example_4inputs.png){#fig-Karnaugh-example-4inputs}
...
![Uppbyggnad av en sjusegmentdisplay. Källa: By user:h2g2bob - Own work  This W3C-unspecified vector image was created with Inkscape ., CC BY-SA 3.0, https://commons.wikimedia.org/w/index.php?curid=1451959.](images/04-boolesk-algebra/7_segment_display_labeled.png){#fig-7seg-display width=15%}
...
En sanningstabell för segment **A** ser ut som följer. Här representerar ingångarna $d3, d2, d1, d0$ de fyra bitarna i det hexadecimala värdet (0–F). Segment **A** är utgång:
...
Karnaughdiagrammet med fyra insignaler (se @fig-Karnaugh-example-4inputs) ser ut så här:

![Karnaughdiagram för sanningstabellen i @tbl-hex-to-7seg.](images/04-boolesk-algebra/K_map_7seg_segment_a_edited.png){#fig-hex-to-7seg width=40%}
...
![Karnaughdiagram för A-segmentet för en BCD-till-sjusegmentavkodare.](images/04-boolesk-algebra/K_map_BCD_7seg_segment_a_edited.png){#fig-BCD-to-7seg width=40%}
...
Lyckligtvis finns det onlineverktyg som hjälper till med detta. https://karnaughmapsolver.com/ som använts för att skapa diagrammen i denna litteratur har stöd för upp till fem ingångar. Andra verktyg har ännu fler möjligheter.
...
![Karnaughdiagram för BCD-till-sjusegmentsavkodare och A-segmentet. Här ringas nollor in, det vill säga uttryck för POS tas fram.](images/04-boolesk-algebra/K_map_POS_BCD_7seg_segment_a_edited.png){#fig-Karnaugh-BCD-to-7seg-POS width=40%}

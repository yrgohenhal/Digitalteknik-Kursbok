...
För att tolka notationen på ett korrekt sätt behövs vissa räkneregler som vi till stor del känner igen från den vanliga algebran.
...
1. *Storleken spelar roll:* Vi vill skapa så stora grupper som möjligt i potenser av 2 ($1, 2, 4, 8, 16$).

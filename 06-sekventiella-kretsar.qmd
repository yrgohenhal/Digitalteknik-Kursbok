...
![D-latch. Inverteraren gör att ingångarna till det som är SR-latch med enable inte kommer ha samma värde, mer än under den korta tidsfördröjning som inverteraren har för att ändra utsignalen.](images/06-sekventiella-kretsar/D_latch.png){#fig-D-latch width=72%}
...
|:-:|:-:|:--:|:--:|:------|
| 0 | X | $Q_0$ | $\overline{Q_0}$ | **Vila:** Ingen ändring. |
| 1 | X | $Q_0$ | $\overline{Q_0}$ | **Vila:** Ingen ändring. |
| ↓ | X | $Q_0$ | $\overline{Q_0}$ | **Vila:** Ingen ändring. |
